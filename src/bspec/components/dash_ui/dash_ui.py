...
@versionadded(
    ...
    reason="This will allow for a dynamic **kwargs to be created to allow dynamic elements to\
         be loaded and used with dash",
)
@component
class Dash_Ui:
    """This is the dynamic elements of dash

    Params:
        **kwargs: This is the dynamic **kwargs for dynamic elements of dash
    """
...
def register() -> None:
    """use `component_factory` to register the `Dash_Ui` component as 'dash_ui'"""
    component_factory.register("dash_ui", Dash_Ui)
